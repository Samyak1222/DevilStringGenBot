...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@devillok1"))
        else:
            ...
            await client.join_chat("devillok1")
    except KeyError:
        pass
    try:
